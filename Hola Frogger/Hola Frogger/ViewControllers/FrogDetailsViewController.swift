...
class FrogDetailsViewController: UIViewController, MKMapViewDelegate, AwesomeSpotlightViewDelegate, QLPreviewControllerDataSource {
    ...
    override func viewDidLoad() {
        ...
        isSimulator = findDevice()
        getDataFromUrl()
        mapView.delegate = self
        setFrogDetailsInView()
        customizeFrogInmageView()
        customiseFavouriteButton()
        customiseCloseButtom()
        checkForSpotLight()
    }
    ...
    fileprivate func setFrogDetailsInView() {
        // When the Map is loaded the Map will focus to the below location and puts the annotation marker.
    ...
    fileprivate func customizeFrogInmageView() {
    ...
    fileprivate func customiseFavouriteButton() {
    ...
    fileprivate func customiseCloseButtom() {
