...
class CoreDataHandler: NSObject {
    ...
    class func addAllRecords() {
        ...
        CoreDataHandler.saveFrog(entityName: "FrogEntity", sname: "Geocrinia laevis", frogcount:4, cname: "Tasmanian Smooth Froglet", desc:"Their physique consists of grey, brown colour skin tone with red streaks and pink streaks near rear legs. They can be of different colours such as clear brown, clear red, clear white and clear grey. They can be found near woods, wet vegetation, shrubs and jungles. They serve on insects.", latitude: -38.5081, longitude:142.989, uncertainty: 2600, threatnedStatus: "Not endangered", isVisited: false, isFavourite: false)
        ...
        CoreDataHandler.saveFrog(entityName: "FrogEntity", sname: "Litoria paraewingi", frogcount: 27, cname: "Plains Brown Tree Frog", desc: "Their physique comprises of light brown shades along with dark spots. They can be of different colours such as clear brown, clear white and clear yellow. They are found near damp areas. They serve on insects.",latitude: -37.53, longitude:145.336, uncertainty: 65, threatnedStatus: "Not endangered", isVisited: false, isFavourite: false)
