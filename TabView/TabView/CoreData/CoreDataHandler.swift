...
class CoreDataHandler: NSObject {
    ...
    class func fetchAllUnsightedFrogs() -> [UnSightedFrogEntity] {
        ...
        do {
            frogs = try context.fetch(UnSightedFrogEntity.fetchRequest())
        } catch {
            print(error, "Error while fetching data in CoreDataHandler")
        }
        return frogs
