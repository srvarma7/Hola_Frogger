...
class CoreDataHandler: NSObject {
    ...
    class func addAllRecords() {
        ...
        CoreDataHandler.saveFrog(sname: "Crinia signifera", frogcount:2284, cname: "Eastern Common Froglet", desc: "Their physique is  grainy white  or grainy grey alongwith black marks near belly. They can be of different colours such as clear brown , clear black , clear green ,clear grey, clear white and clear red . They are found near water pools , streams, moist lands where they can take refuge. They serve on insects.", latitude: -37.6803, longitude:140.972, uncertainty: 3, threatnedStatus: "Not endangered", isVisited: false, isFavourite: false)
        ...
        CoreDataHandler.saveFrog(sname: "Neobatrachus sudellae", frogcount: 2, cname: "Common Spadefoot Toad", desc: "Their physique consists of yellow ,brown ,grey, green coloured skin tone with streaks along back of their body . They are found near marshlands , metropolitan regions and streams. They can be found near arid regions, woods, roadside pools and bushes . They serve on insects.",latitude: -38.0538, longitude:141.009, uncertainty:10, threatnedStatus: "Not endangered", isVisited: false, isFavourite: false)
