...
class CoreDataHandler: NSObject {
    ...
    class func addAllRecords() {
        CoreDataHandler.saveFrog(entityName: "FrogEntity", sname: "Crinia parinsignifera", frogcount: 319, cname: "Eastern Sign-bearing Froglet", desc: "Their physique is white, grainy or grey-skinned with marks which are black near their abdominal area. They can be of different colours such as clear brown, clear black, clear green, clear white, clear grey and clear red. They belong to woods or marshlands. They serve on insects.", latitude: -37.7401, longitude: 141.091, uncertainty: 294, threatnedStatus: "Not endangered", isVisited: true, isFavourite: false)
        ...
        CoreDataHandler.saveFrog(entityName: "FrogEntity", sname: "Geocrinia laevis", frogcount:4, cname: "Tasmanian Smooth Froglet", desc:"Their physique consists of grey, brown colour skin tone with red streaks and pink streaks near rear legs. They can be of different colours such as clear brown, clear red, clear white and clear grey. They can be found near woods, wet vegetation, shrubs and jungles. They serve on insects.", latitude: -38.5081, longitude:142.989, uncertainty: 2600, threatnedStatus: "Not endangered", isVisited: true, isFavourite: false)
        ...
        CoreDataHandler.saveFrog(entityName: "FrogEntity", sname: "Limnodynastes dumerilii", frogcount:814, cname: "Eastern Banjo Frog", desc: "Noticeable bump on rear legs with faint streaks. They can be of different colours such as clear brown, clear black, clear yellow, clear white, clear grey. They belong to metropolitan jungle areas. They serve on insects.", latitude: -37.5801062537707, longitude:141.399294063581, uncertainty:5, threatnedStatus: "Not endangered", isVisited: true, isFavourite: false)
        ...
        CoreDataHandler.saveFrog(entityName: "FrogEntity", sname: "Litoria paraewingi", frogcount: 27, cname: "Plains Brown Tree Frog", desc: "Their physique comprises of light brown shades along with dark spots. They can be of different colours such as clear brown, clear white and clear yellow. They are found near damp areas. They serve on insects.",latitude: -37.53, longitude:145.336, uncertainty: 65, threatnedStatus: "Not endangered", isVisited: true, isFavourite: false)

        CoreDataHandler.saveFrog(entityName: "FrogEntity", sname: "Litoria peronii", frogcount: 246, cname: "Peron's Tree Frog", desc:"Their physique comprises of light shades ranging from light greenish or light greyish to light red or light brownish along with dark and vivid yellow patterns on their armpits. They can be of different colours such as clear brown, clear black, clear yellow, clear green and clear grey. They belong to jungle habitats, open spaces, exposed grasslands. They serve on insects.",latitude: -37.7238, longitude:142.015, uncertainty: 19, threatnedStatus: "Not endangered", isVisited: true, isFavourite: false)
